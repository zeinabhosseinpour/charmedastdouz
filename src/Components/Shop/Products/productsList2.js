...
const category = {
  ...
  kafsh: ["کفش زنانه", "کفش مردانه "],
  poshak: ["دستکش چرمی", "لباس چرمی", "کلاه چرمی"],
  dekor: ["تابلو چرمی", "فرش چرمی", "کوسن چرمی"],
  children: ["کوله پشتی بچگانه"],
  charm: ["چرم گاوی", "چرم بزی", "چرم شتر", "چرم مار پیتون", "چرم شترمرغ"],
};
