...
const category1 = [
  {
    ...
    hasChild: 0,
    child: [
      { id: 11, slug: "کیف_مجلسی_زنانه", title: "کیف مجلسی زنانه" },
      { id: 12, slug: "کیف_دوشی_زنانه", title: "کیف دوشی زنانه" },
      { id: 13, slug: "کیف_دستی_زنانه", title: "کیف دستی زنانه" },
      { id: 14, slug: "کیف_کج_یکطرفه", title: "کیف کج یکطرفه" },
      { id: 15, slug: "کوله_پشتی", title: "کوله پشتی" },
      { id: 16, slug: "کیف_پول_کتی", title: "کیف پول کتی" },
      { id: 17, slug: "کیف_پول_جیبی_مردانه", title: "کیف پول جیبی مردانه" },
    ],
  },
  {
    id: 3,
